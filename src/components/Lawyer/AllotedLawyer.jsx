...
const validLawyers = lawyersData; // or a smarter filter if needed
  ...
  const specializations = [...new Set(lawyers.map(l => l.specialization || 'General Law'))];
                ...
                <div className="p-4 flex gap-4">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    >
                      {lawyer.profileImage ? (
                        <img
                          src={`${API_BASE_URL}/uploads/${lawyer.profileImage}`}
                          alt={lawyer.name}
...
export default AllotLawyerCard;

            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-5 rounded-lg">
                <p className="text-gray-700 leading-relaxed">
                  {lawyer.about ||
                    `${lawyer.name} is a distinguished ${lawyer.specialization || "legal professional"} 
                    with ${lawyer.experience || "extensive"} years of experience practicing in ${lawyer.city || "multiple jurisdictions"}. 
                    Admitted to the bar in good standing, ${lawyer.name.split(" ")[0]} specializes in providing 

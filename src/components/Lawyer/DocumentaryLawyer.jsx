    ...
    >
      <div className="p-4 flex gap-4">
        ...
        <div className="flex flex-col items-center">
          <div className="w-20 h-20 rounded-full bg-[#000080]/10 text-[#000080] flex items-center justify-center font-bold text-xl">
            NA
          </div>
          <div className="text-xs text-gray-500 mt-2">—</div>
        </div>

        {/* Lawyer Info Placeholder */}
        ...
        <div className="flex flex-col items-end justify-between">
          ...
          <button
            className="mt-2 text-sm px-3 py-1.5 rounded-md bg-gray-300 text-gray-500 cursor-not-allowed"
            disabled
          >
            Chat Now
          </button>
          <span className="text-xs text-gray-400 mt-1">Available 9am-5pm</span>
        </div>
      </div>
    </motion.div>
  </div>
      ...
      return (
        ...
        >
          <div className="p-4 flex gap-4">
            ...
            <div className="flex flex-col items-end justify-between">
              <span
                className={`text-xs px-2 py-1 rounded-full ${statusStyles.textColor} ${statusStyles.bgColor}`}
              >
                {statusStyles.label}
              </span>
              <button

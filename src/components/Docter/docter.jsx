...
const LawyerCard = () => {
  ...
  useEffect(() => {
    const fetchLawyers = async () => {
      try {
        ...
        console.log("hwwww joeee",lawyersData)
        // Filter lawyers with STRICTLY more than 5 years experience
        const experiencedLawyers = lawyersData.filter(lawyer => 
          lawyer.experience >= 3
        );
  ...
  if (lawyers.length === 0) {
    return (
      <div className="text-center py-10 text-gray-600">
        No lawyers found with more than 5 years experience.
      </div>
    );
  }
  ...
  return (
	<div className="">
							<h2 className="text-3xl mt-11 font-bold flex justify-center text-gray-900 sm:text-4xl mb-4">
...
>
  ...
  className="bg-gradient-to-r from-[rgb(40,62,81)] to-[rgb(72,85,99)] text-white px-4 py-2 rounded-lg transition-all duration-300 hover:opacity-90"
>
  Book Appointment
</button>
            </div>

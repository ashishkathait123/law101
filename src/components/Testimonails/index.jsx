    ...
    const testimonials = [
        {
            ...
            quote: "LegalUp connected me with the perfect lawyer for my property dispute. The process was seamless and saved me months of research.",
            image: "https://randomuser.me/api/portraits/men/32.jpg"
        },
        {
            name: "Priya Sharma",
            role: "Business Owner",
            quote: "The transparent pricing helped me budget my legal expenses accurately. I knew exactly what to expect from the beginning.",
            image: "https://randomuser.me/api/portraits/women/44.jpg"
        },
        {
            name: "Rahul Gupta",
            role: "DevOps Specialist",
            quote: "24/7 support was a lifesaver when I needed urgent legal advice during an international business deal. Highly recommended!",
            image: "https://randomuser.me/api/portraits/men/22.jpg"
        },
        {
            name: "Ananya Reddy",
            role: "Graphic Designer",
            quote: "The secure communication platform gave me peace of mind while discussing sensitive legal matters. Very professional service.",
            image: "https://randomuser.me/api/portraits/women/63.jpg"
        }
    ];

    return (
        <section id="id-testimonials" className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50 to-white">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <div className="inline-block bg-blue-100 p-4 rounded-full mb-6">
                        <svg className="w-8 h-8 text-blue-600" viewBox="0 0 48 42" fill="currentColor">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        Don't just take our word for it. Hear from professionals who found the right legal help through our platform.
                    </p>
                </motion.div>
                        ...
                        >
                            <div className="p-8">
                                ...
                                <p className="text-gray-600 italic relative">
                                    <svg 
                                        className="absolute -top-4 -left-2 w-6 h-6 text-blue-100" 
                                        viewBox="0 0 24 24" 
                                        fill="currentColor"
                                    >
